...
|---|---|---|---|
| Color objective | Weighted squared Oklab distance | RGB channel distance; fixed colors | Uses a perceptual color representation and weights logical drawing content. |
